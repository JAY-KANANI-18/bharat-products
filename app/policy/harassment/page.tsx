          ...
          <AnimatedSection animationType="fade-up" delay={480}>
            <div className="mt-8 p-6 rounded-2xl border border-gray-200 bg-white">
              ...
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-3 text-foreground/80">
                <li className="flex items-start gap-2"><ShieldCheck className="w-5 h-5 text-primary mt-0.5" /> Zero tolerance: Harassment in any form will not be tolerated.</li>
                <li className="flex items-start gap-2"><Handshake className="w-5 h-5 text-primary mt-0.5" /> Respect & Fairness: Every employee is entitled to integrity and equality.</li>
                <li className="flex items-start gap-2"><BadgeCheck className="w-5 h-5 text-primary mt-0.5" /> Growth & Development: We support continuous learning and advancement.</li>
                <li className="flex items-start gap-2"><HardHat className="w-5 h-5 text-primary mt-0.5" /> Safe Environment: A culture of trust, transparency, and accountability.</li>
              </ul>
            </div>
          </AnimatedSection>
        </div>
