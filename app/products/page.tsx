...
const products = [
  ...
  },
  {
    ...
    description:
      "Advanced sound dampening materials designed to reduce noise and vibration in various applications.",
    image:
  ...
  },
  {
    ...
    description:
      "Electrically conductive adhesives for electronic assembly and EMI shielding applications.",
    image:
      "https://images.unsplash.com/photo-1518709268805-4e9042af2176?w=600&h=400&fit=crop",
    features: [
  ...
  },
  {
    ...
    description:
      "High-performance thermal interface materials for efficient heat transfer in electronic devices.",
    image:
      "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=600&h=400&fit=crop",
    features: [
  ...
  },
  {
    ...
    description:
      "Precision die-cut components manufactured to exact specifications for various industrial applications.",
    image:
  ...
  },
  {
    ...
    description:
      "Durable protective films designed to safeguard surfaces during manufacturing and transport.",
    image:
      "https://images.unsplash.com/photo-1565008447742-97f6f38c985c?w=600&h=400&fit=crop",
    features: [
      "Scratch protection",
  ...
  },
  {
    ...
    description:
      "High-performance insulation materials for thermal and electrical isolation in demanding environments.",
    image:
      "https://images.unsplash.com/photo-1559136555-9303baea8ebd?w=600&h=400&fit=crop",
    features: [
      "Thermal insulation",
