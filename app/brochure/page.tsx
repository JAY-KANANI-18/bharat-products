  ...
  const brochures = [
    {
      ...
      description:
        "Overview of Bharat Products' capabilities, services, and expertise.",
      size: "—",
      format: "PDF",
      href: "/docs/bharat_product.pdf",
      Icon: FileText,
    },
    {
      title: "Product Catalogue",
      description:
        "Detailed catalogue of our precision-engineered components and specifications.",
      size: "—",
      format: "PDF",
      href: "/docs/bharat_product.pdf",
      Icon: FileText,
    },
    {
      ...
      description: "Our ISO and quality certification documentation.",
      size: "—",
      format: "PDF",
      href: "/docs/bharat_product.pdf",
      Icon: BadgeCheck,
        ...
        <div className="relative max-w-6xl mx-auto px-5 md:px-8 text-center">
          ...
          <AnimatedSection animationType="fade-up" delay={200}>
            <h1 className="text-5xl md:text-6xl font-bold text-black mb-6 font-red_hat_display">
              Download <span className="text-primary">Documents</span>
            </h1>
          </AnimatedSection>

          <AnimatedSection animationType="fade-up" delay={400}>
            <p className="text-lg md:text-xl text-gray-700 leading-8 max-w-3xl mx-auto mb-12">
              Get the Company Brochure, Product Catalogue, and Quality
              ...
              >
                <div className="p-8 border border-gray-200 rounded-xl hover:shadow-lg transition-all hover:border-primary">
                  <div className="flex items-start justify-between mb-4">
                    <brochure.Icon className="w-10 h-10 text-primary flex-shrink-0" />
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-8 text-center">
          <AnimatedSection animationType="fade-up" delay={0}>
            ...
            <p className="text-lg text-foreground/70 mb-8">
              Contact our team to request custom brochures or technical
