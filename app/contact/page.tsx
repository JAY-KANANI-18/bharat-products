  ...
  const contactInfo = [
    {
      ...
      title: "Phone",
      value: "+918460524463",
      link: "tel:+918460524463",
    },
    {
      icon: Mail,
      title: "Email",
      value: "info@bharatprod.com",
      link: "mailto:info@bharatprod.com",
    },
    {
      icon: MapPin,
      title: "Address",
        ...
        <div className="relative max-w-6xl mx-auto px-5 md:px-8 text-center">
          ...
          <AnimatedSection animationType="fade-up" delay={400}>
            <p className="text-lg md:text-xl text-gray-700 leading-8 max-w-3xl mx-auto mb-12">
              ...
              from you. Contact us today and let's discuss how we can help your
              business.
            </p>
          </AnimatedSection>
            ...
            {contactInfo.map((info, index) => {
              ...
              return (
                ...
                >
                  <a
                    href={info.link}
                    className="p-6 border border-gray-200 rounded-xl hover:shadow-lg transition-all hover:border-primary text-center block"
                  >
